...
class EmployeeDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            'document' => ['render' => '(data)? ((data.length>180)? data.substr(0,180)+"..." : data) : "-"', 'title' => 'CPF'],
            'phone_numer' => ['render' => '(data)? ((data.length>180)? data.substr(0,180)+"..." : data) : "-"', 'title' => 'Telefone'],
            'employee_type' => ['render' => '(data)? ((data.length>180)? data.substr(0,180)+"..." : data) : "-"', 'title' => 'Função'],
        ];
    }
